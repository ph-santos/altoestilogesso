...
## Link do projeto: https://ph-santos.github.io/altoestilogesso/
Esse projeto consiste em um página feita com HTML, CSS e JavaScript para a visualização dos serviços e contato com a empresa Alto Estilo Gesso & Decorações. O site e responsivo com funcionalidade como tema escuro, menu mobile, um botão para ir direto ao Whatssapp, um formulário para envio de email usando a ferramenta Static forms (Integra formulários HTML facilmente sem qualquer código do servidor) e um Sistema de Orçamento Oline.
## Layout mobile
